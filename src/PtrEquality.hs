...
--
-- https://github.com/haskell/containers/blob/2eb64f5f513b3209880713c88ab53eb4f528c0f8/Utils/Containers/Internal/PtrEquality.hs
--
-- on Nov 11, 2016
{-# LANGUAGE CPP #-}
...
module PtrEquality (ptrEq, hetPtrEq) where
